...
export default function Overview() {
  ...
  return <div className="readiness-page">
    ...
    {!readinessDataComplete && <p className="readiness-data-notice">Readiness uses the employee and skill records loaded from the backend. Workforce coverage and role requirements have not been verified as complete.</p>}
