...
CREATE TABLE roles (id TEXT PRIMARY KEY, title TEXT NOT NULL UNIQUE);
CREATE TABLE skills (id TEXT PRIMARY KEY, name TEXT NOT NULL UNIQUE, category TEXT NOT NULL DEFAULT 'uncategorized');
...
CREATE INDEX employee_department ON employees(department_id);
CREATE INDEX employee_skill_lookup ON employee_skills(skill_id);
